...
You can start using Ms-teams directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Ms-teams.
...
The full list of available tools is at [./src/universal_mcp_ms_teams/README.md](./src/universal_mcp_ms_teams/README.md)
